    ...
    async execute(interaction) {
      ...
      const fields = [
          ...
          },
          {
            ...
            name: '🎥 방송 기록',
            value: [
              '**`/방송 링크:<이번 방송 주소>`** — 유튜브 스튜디오의 공유 링크를 붙여넣으세요.',
              '**일부공개로 켜면 방송마다 넣어야 합니다.** 공개 방송이면 `…/@내계정/live` 를',
              '같은 게임이면 제어판의 **🎬 지난 게임으로 등록** 만 누르면 됩니다.',
              ...
              '녹화 포스트에도 방송자·시작 날짜·링크·타임라인을 올리고, 설명 수정 시 함께 갱신합니다.',
