    ...
    async execute(interaction) {
      ...
      const fields = [
          ...
          },
          {
            ...
            name: '🎥 방송 기록',
            value: [
              '**`/방송 게임명:<게임>`** — 링크 없이 기록부터 시작합니다.',
              '종료 뒤 본인 요약이나 녹화방의 **🔗 다시보기 연결**에 유튜브 주소를 넣으세요.',
              '방송자 본인과 서버 관리자가 연결할 수 있고, 기존 녹화방 글이 같은 자리에서 갱신됩니다.',
              '원하면 라이브를 켠 뒤 `/방송 링크:… 게임명:…`으로 바로 연결해도 됩니다.',
              ...
              '**⏹️ 내 방송 종료** 는 **누른 사람 것만** 끝냅니다. 먼저 끝내고 나가도 남은 사람 기록은 계속됩니다.',
              '누르면 본인의 유튜브 설명란용 타임라인이 나만 보기로 나옵니다.',
              '링크가 없어도 녹화 포스트에 연결 대기로 올리고, 나중에 연결하면 같은 글을 갱신합니다.',
              '요약판의 **🎥 클립 만들 순간 고르기** 로 그 구간만 영상으로 잘라 받을 수 있습니다.',
              '`/클립` — 이 서버의 모든 방송에서 추출한 클립을 최신순으로 모아봅니다.',
